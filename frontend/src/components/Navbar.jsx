...
const ROLE_LINKS = {
  student: [
    ...
    { to: "/wishlist", label: "Wishlist", id: "nav-wishlist" },
    { to: "/compare", label: "Compare", id: "nav-compare" },
  ],
  ...
  counselor: [
    ...
    { to: "/counselor/wishlists", label: "Wishlists", id: "nav-counselor-wishlists" },
  ...
  principal: [
    ...
    { to: "/principal/wishlists", label: "Wishlists", id: "nav-principal-wishlists" },
